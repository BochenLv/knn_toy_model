...
Hypernets can save such efforts to a large extent. First, it decoupled the basic components of a general AutoML model as three distinct parts: the HyperSpace, the Searcher and the Estimation Strategy (Fig. \ref).
